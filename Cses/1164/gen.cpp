...
void solve() {
  ...
  int n = uniform_int_distribution<int> (1, 1000) (gen);
  ps(n, nl);

  for (int i = 0; i < n; ++i) {
    int u = uniform_int_distribution<int> (1, 100000) (gen);
    int v = uniform_int_distribution<int> (1, 100000) (gen);
    ps(u, " ", v, nl);
  }
}

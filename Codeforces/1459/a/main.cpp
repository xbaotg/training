...
void solve() {
    ...
    int i = std::inner_product(all(a), b.begin(), 0, plus<int>(), greater<char>());
    int j = std::inner_product(all(b), a.begin(), 0, plus<int>(), greater<char>());

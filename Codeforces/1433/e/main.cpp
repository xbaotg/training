...
template<class H, class... T> void re(H &v, T&... args) { read(v); read(args...); };
...
void ps() {};
template<typename Head, typename... Tail> void ps(Head H, Tail... T) { cout << H; print(T...); }; 
